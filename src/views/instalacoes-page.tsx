    ...
    <div className="pt-16 md:pt-20 min-h-screen">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-10 md:py-16">
        ...
        <motion.div
          ...
          className="max-w-2xl"
        >
          <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold text-foreground mb-3 md:mb-4">Instalações</h1>
          ...
          <div className="space-y-5 md:space-y-6">
            <div className="p-5 sm:p-6 rounded-2xl border border-border bg-white shadow-sm">
              <h2 className="text-base sm:text-lg font-semibold text-foreground mb-4">Como funciona</h2>
              <div className="space-y-0">
                {HOW_WE_WORK.map((step) => (
                  <div key={step.step} className="flex gap-3 sm:gap-4 py-3.5 sm:py-4 border-b border-border last:border-b-0">
                    <div className="flex-shrink-0 w-8 h-8 rounded-full bg-primary text-primary-foreground flex items-center justify-center text-xs sm:text-sm font-bold">
                      {step.step}
                    </div>
                    <div className="min-w-0">
                      <h3 className="text-xs sm:text-sm font-semibold text-foreground">{step.title}</h3>
                      <p className="mt-0.5 text-xs sm:text-sm text-muted-foreground leading-relaxed">{step.description}</p>
                    </div>
                  </div>
                ))}
              </div>
            ...
            <div className="p-5 sm:p-6 rounded-2xl border border-border bg-white shadow-sm">
              <h2 className="text-base sm:text-lg font-semibold text-foreground mb-4">O que instalamos</h2>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5">
                {[
                  ...
                  <div key={item} className="flex items-center gap-2 text-xs sm:text-sm text-foreground">
